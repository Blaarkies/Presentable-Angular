...
@NgModule({
  ...
  declarations: [CompressionShowcaseComponent, EntropyCardComponent, HuffmanTreeComponent, EntropyInfoComponent, HuffmanNodeComponent, NodeConnecterComponent, PageDataAndInformationComponent, PageDataWithoutPatternComponent, PageRunLengthEncodingComponent, PageHuffmanCodingTreeComponent, PageHuffmanCodingEncodeComponent, PageQuestionsComponent, PageLempelZivWelchComponent]
})
